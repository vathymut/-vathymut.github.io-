...
not all statistical tests are well-suited for this. The main point of
...
equal distribution and of mean difference are lacking when it comes to the
Question &copy;.
...
@kamulete2022test, published in UAI2022. Here are a few more that answer
the Question &copy; more rigorously and precisely
[@podkopaev2021tracking; @luo2022online; @vovk2021retrain; @harel2014concept]
^[One rich, active and effective paradigm that to my mind does not get its due
...
this.]. When discussing my own work and the `dsos` package at
...
If you stuck with me this far, first I am sorry, not
...
tests than those of equal distribution and of mean difference for testing
for harmful or adverse shift, we also happen to have a growing number of such
