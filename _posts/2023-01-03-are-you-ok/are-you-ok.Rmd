...
<aside>
The more covert point, the less altruistic one to put it kindly, is to motivate
...
their fault; it's ours, the users) when testing for adverse shift. They fail
because "not all changes in distribution are a cause for concern - some
changes are benign" [@kamulete2022test]. Here is a simple pathological example
to convince yourself of this. Suppose that your original sample was
contaminated with a few outliers. But your new
sample is free of outliers. You're clearly better off. Well, tests of equal
...
tests don't answer the Question &copy;; they tell us when both samples
can be said to be identical, not whether we are worse off. As we know
all too well, *different* does not mean *inferior*. We need a better
test.
...
@kamulete2022test, published in UAI2022. Here are a few more that tackle
the Question &copy; more rigorously (precisely)
...
sorry 😉, for abusing the Question &copy; as a short form for testing
for adverse shift. It is, we agree, a silly trope not meant to be taken
