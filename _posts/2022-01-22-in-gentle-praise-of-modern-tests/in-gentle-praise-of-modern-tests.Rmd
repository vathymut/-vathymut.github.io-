...
hypothesis holds. That is easy enough.
...
academic journals, not if you're hanging out on Twitter). @kirchler2020two
is a nice example of this trend. Their test statistics is
<abbr title="Maximum Mean Discrepancy">MMD-inspired</abbr> and to spice it up,
they sprinkle some deep learning in between. Even energy tests, one of the
innovation that Uncle Larry discusses, are in a fundamental sense
kernel tests [@sejdinovic2012hypothesis; @shen2020exact]. It is kernels all
the way down. Do not get me wrong. I like me some kernels too. The math *is*
elegant -- you get arcane incantations to voodoo magic such as
...
trinity, meaning no offense.]. Plenty of works advocate for the two-sample
classifier test [@friedman2004multivariate; 
